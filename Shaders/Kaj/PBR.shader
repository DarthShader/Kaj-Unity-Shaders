Shader "Kaj/PBR"
{
    Properties
    {
        ...
        [HideInInspector]helpbox_TriplanarTooltip("Object and World Triplanar sampled textures are scaled using each texture's Tiling X parameter.", Int) = 0
        ...
        [KajLabel]_Version("Shader Version: 15", Int) = 15
    }
